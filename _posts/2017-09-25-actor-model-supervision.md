...
> `try/catch` blocks should only be used for situations where something really goes wrong. 
...
We simply check if one of the child actors fails, and escalate when we do. 
